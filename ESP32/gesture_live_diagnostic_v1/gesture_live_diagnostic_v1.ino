...
uint32_t diagnosticCaptureSequence = 0;
...
void printDiagnosticCaptureCsv()
{
  diagnosticCaptureSequence++;

  Serial.println();
  Serial.printf(
    "LIVE_DIAGNOSTIC_BEGIN,%lu\n",
    static_cast<unsigned long>(diagnosticCaptureSequence)
  );
